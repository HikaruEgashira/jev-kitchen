...
- 並行作業の`jev-bench`（main `58f302f`）と統合し、108 tests、typecheck、check（49 files／lint31、警告なし）、build、diff-checkがpass。Kitchen chunkはgzip559.66kB、フォントatlasは非圧縮2,871,092B。既知のchunk警告は継続する。
