...
## 2026-09-20 主要ボタンの拡大・横向きダイアログの下部操作バー・Eの作業台優先・厨房の6%下降配信
...
- commit `492b4fd`（UI・E）、`8d40861`（下降の初回）、`cd3cadb`（カメラリグ方式への修正）をmainへpush。本番100% versionは`e441418c-dea1-4d18-9277-061d81edaab0`。`GET /`は200で配信bundleはローカルbuildと一致（`index-Cejk2ICr.js`）。
