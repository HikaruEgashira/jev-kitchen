 ...
 */
import { STOCK_PRICE, resolveLayout, recommendedStock } from './model.js';
import { levelConfig, quotaForLevel, MAX_LEVEL } from './progression.js';
import { STAFF, nextStaffState, nextDuty, payroll, staffAvailable } from './staff.js';
import { quoteEquipment } from './equipment.js';
import { quoteVitamins } from './training.js';
...
export function nextShiftParams(
  ...
  if (selected && hired.includes(applicantId)) return null;
  if (selected) {
