...
- Lv3でスープ、Lv5で手動ブースト、Lv6で焦げ、Lv7でグリル、Lv8で2人稼働、Lv9で連勤と休養、Lv10でラッシュを解放する。加熱できないハルと組む間は、プレイヤーが鍋とグリルを担当する。
- Lv2以降は各90秒。Lv2〜7は9皿、Lv8〜10は11皿、以降は計算式で最大16皿へ難化する。注文猶予は30秒から20秒へ短くなる。星は600／1800／3600点の得点評価で、ノルマ判定とは別に扱う。
