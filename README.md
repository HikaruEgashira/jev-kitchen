...
- Lv2は店長のアオと営業する。全工程とダッシュに対応するが、給与は85コイン。終了後はLv3〜7を休み、Lv8から再び出勤できる。Lv3は見習いのハルと組み、以降は勤務表で相棒を選ぶ。
- Lv4でスープ、Lv5で手動ブースト、Lv6で焦げ、Lv7でグリル、Lv8で2人稼働、Lv9で連勤と休養、Lv10でラッシュを解放する。加熱できないハルと組む間は、プレイヤーが鍋とグリルを担当する。
